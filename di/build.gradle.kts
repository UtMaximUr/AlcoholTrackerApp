plugins {
    ...
    alias(libs.plugins.custom.koin.common)
...
kotlin {
    ...
    sourceSets {
        commonMain.dependencies {
            ...
            implementation(projects.features.track.geocoder.main.componentInternal)
            implementation(projects.features.track.geocoder.data)
            implementation(projects.features.track.tracksModal.main.componentInternal)
            implementation(projects.features.track.tracksModal.data)
