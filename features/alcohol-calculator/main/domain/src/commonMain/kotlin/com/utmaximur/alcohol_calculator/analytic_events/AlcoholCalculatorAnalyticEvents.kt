package com.utmaximur.alcohol_calculator.analytic_events
...
internal data class OpenScreenEvent(
    ...
    override val params: Map<String, Any> = mapOf(Param.SCREEN_NAME to ParamValues.ALCOHOL_CALCULATOR_SCREEN)
