...
includeFeature("map:data")
includeFeature("map:domain")
includeFeature("map:navigation:component-api")
includeFeature("map:navigation:component-internal")
...
includeFeature("track:tracks-modal:data")
includeFeature("track:tracks-modal:domain")
includeFeature("track:tracks-modal:main:domain")
includeFeature("track:tracks-modal:main:component-api")
includeFeature("track:tracks-modal:main:component-internal")
...
includeFeature("settings:sorting-drinks:data")
includeFeature("settings:sorting-drinks:domain")
includeFeature("settings:sorting-drinks:main:domain")
includeFeature("settings:sorting-drinks:main:component-api")
includeFeature("settings:sorting-drinks:main:component-internal")
...
includeFeature("drink:kandinsky:data")
includeFeature("drink:kandinsky:domain")
