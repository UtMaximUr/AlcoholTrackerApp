...
import com.utmaximur.utils.setVolumeUnit
...
fun VolumeNumberPicker(
    ...
    val volumeValue = viewModel.volumeState.observeAsState(Int.zero())
...
fun DegreeNumberPicker(
    ...
    val degreeValue = viewModel.degreeState.observeAsState(Int.zero())
