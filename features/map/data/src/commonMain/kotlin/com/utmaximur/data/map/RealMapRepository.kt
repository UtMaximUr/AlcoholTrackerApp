...
import com.utmaximur.data.map.mappers.PlaceMarkDomainMapper
...
internal class RealMapRepository(
    ...
    private val placeMarkDomainMapper: PlaceMarkDomainMapper,
    ...
    override fun observePlace() = placeDao.getAll()
        .mapList(placeMarkDomainMapper::transform)
}
