...
object ApiConstants {
    ...
    const val GET_MODELS_ENDPOINT = "key/api/v1/pipelines"
    const val GENERATION_REQUEST_ENDPOINT = "key/api/v1/pipeline/run"
    const val CHECK_GENERATION_RESULT_ENDPOINT = "key/api/v1/pipeline/status/{id}"
